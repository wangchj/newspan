    ...
    render:function(){
        switch(this.state.progress) {
            ...
            case 2: //Squares practice block
                return <Block block={this.props.blocks[0]} practice={true} randomize={true} onComplete={this.advance} />
            ...
            case 5: //Symmetry practice block
                return <Block block={this.props.blocks[1]} practice={true} randomize={true} onComplete={this.advance}/>
            ...
            case 8: //Symmetry and squares practice block
                return <Block block={this.props.blocks[2]} practice={true} randomize={true} keepTra={true} onComplete={this.advance}/>
